...
@dataclass
class GAWSConfig(PeftConfig):
    """
    This is the configuration class to store the configuration of a [`GAWSModel`].
    ...
    Args:
        ...
        bias (`str`):
            Bias type for the layer. Can be 'none' or 'all' or 'gaws_only'. If 'all' or 'gaws_only', the corresponding biases
    ...
    target_modules: Optional[Union[list[str], str]] = field(
        ...
        metadata={
            "help": (
                "List of module names or regex expression of the module names to replace with GAWS."
    ...
    bias: Literal["none", "all", "gaws_only"] = field(
        default="none", metadata={"help": "Bias type for GAWS. Can be 'none', 'all' or 'gaws_only'"}
    )

    modules_to_save: Optional[list[str]] = field(
        default=None,
        metadata={
            "help": "List of modules apart from GAWS layers to be set as trainable and saved in the final checkpoint. "
        },
    )
    diag: bool = field(
        default=False,
        metadata={
            "help": (
                "Whether to add diagonal matrix to GAWS adapter"
            ),
        },
    )
    ...
    init_weights: Literal["zero", "kaiming", "none"] = field(
        default="none", metadata={"help": (
                                  "How to initialize the weights of the GAWS layers. Passing `'none'` (default)"
    ...
    layers_to_transform: Optional[Union[list[int], int]] = field(
        default=None,
        metadata={
            "help": "List of layer indices to be transformed by GAWS. If not specified, all layers in target_modules are transformed "
        },
    )
